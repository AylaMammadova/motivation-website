  ...
  function generateAdvice(name, age, mood, challenge, improvement) {
    ...
    switch (mood) {
      ...
      case 'motivated':
        ...
        break;
      case 'angry':
        moodAdvice = "Anger is natural. Try some calming activities like walking or listening to music. 🎶";
        break;
      case 'confused':
        moodAdvice = "Confusion is the first step to clarity. Take your time and things will fall into place. 🧠";
        break;
      default:
